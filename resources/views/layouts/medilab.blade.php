  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">8040220109</h1>
        <span>.</span>
      </a>
      ...
      <a class="btn-getstarted" href="#book-a-table">Register</a>
  ...
  <main class="main">
    ...
    <div class="row gy-4 justify-content-center justify-content-lg-between">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
            <h1 data-aos="fade-up">Selamat Datang<br>di Project Akademik UNAMA</h1>
            <p data-aos="fade-up" data-aos-delay="80">Pemograman WEB II</p>
            <div class="d-flex justify-content-center justify-content-lg-start" data-aos="fade-up" data-aos-delay="200">
                <a href="#book-a-table" class="btn-get-started">Register</a>
